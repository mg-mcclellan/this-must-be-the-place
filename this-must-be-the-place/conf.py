...
BLOG_AUTHOR = "Mary Grace McClellan"  # (translatable)
BLOG_TITLE = "This Must Be The Place"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://this-must-be-the-place.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://mg-mcclellan.github.io/"
BLOG_EMAIL = "marygracemcclellan@gmail.com"
BLOG_DESCRIPTION = "Sing into my mouth."  # (translatable)
